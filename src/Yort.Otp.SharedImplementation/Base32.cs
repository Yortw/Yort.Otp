...
namespace Yort.Otp
{
	//From http://scottless.com/blog/archive/2014/02/15/base32-encoder-and-decoder-in-c.aspx;
	...
	internal static class Base32
	{
		...
		internal static byte[] FromBase32String(string base32String)
		{
			...
			{
				throw new ArgumentOutOfRangeException(nameof(base32String), "Specified string is not valid Base32 format because it doesn't have enough data to construct a complete byte array");
			}
